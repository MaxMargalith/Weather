...
public class Example {
    ...
    private static void lib0() {
        ForecasterClient forecaster = new DayForecasterAdaptor();
        CachingForecasterClient forecasterClient = new CachingForecasterClient(forecaster, 3);
        Forecast forecast = forecasterClient.forecastFor(Region.LONDON, Day.FRIDAY);

        System.out.println("London outlook: " + forecast.summary());
        System.out.println("London temperature: " + forecast.temperature());
    }
//
